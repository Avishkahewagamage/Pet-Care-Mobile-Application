...
public class Veterinary_surgeon extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vetrinary_surgeon);
    }
    ...
    public void goToSurgeon (View view){
        Intent intent = new Intent(Veterinary_surgeon.this , Surgeon.class);
        startActivity(intent);
    }
}